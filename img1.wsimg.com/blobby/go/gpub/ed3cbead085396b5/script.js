(function () {
    ...
    var onClickApplication = setInterval(function () {
      var membershipSignOut = document.getElementById('membership4324285-membership-sign-out');
  ...
  var utilitiesMenu = document.getElementById('membership4324285-utility-menu');
  ...
  if (cookieValue) {
    ...
    var membershipEmailField = utilitiesMenu.querySelector('#membership4324285-membership-email');
    ...
    var membershipHeaderText = utilitiesMenu.querySelector('#membership4324285-membership-header');
