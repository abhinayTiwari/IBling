(function () {
    ...
    var onClickApplication = setInterval(function () {
      var membershipSignOut = document.getElementById('membership4074469-membership-sign-out');
  ...
  var utilitiesMenu = document.getElementById('membership4074469-utility-menu');
  ...
  if (cookieValue) {
    ...
    var membershipEmailField = utilitiesMenu.querySelector('#membership4074469-membership-email');
    ...
    var membershipHeaderText = utilitiesMenu.querySelector('#membership4074469-membership-header');
