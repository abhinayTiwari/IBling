(function () {
    ...
    var onClickApplication = setInterval(function () {
      var membershipSignOut = document.getElementById('membership5124652-membership-sign-out');
  ...
  var utilitiesMenu = document.getElementById('membership5124652-utility-menu');
  ...
  if (cookieValue) {
    ...
    var membershipEmailField = utilitiesMenu.querySelector('#membership5124652-membership-email');
    ...
    var membershipHeaderText = utilitiesMenu.querySelector('#membership5124652-membership-header');
