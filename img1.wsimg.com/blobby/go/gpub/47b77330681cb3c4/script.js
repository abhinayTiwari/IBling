(function () {
    ...
    var onClickApplication = setInterval(function () {
      var membershipSignOut = document.getElementById('n-4375-membership-sign-out');
  ...
  var navigationDrawer = document.getElementById('n-4375-navId-mobile');
  ...
  if (cookieValue) {
    ...
    var membershipHeader = navigationDrawer.querySelector('#n-4375-membership-header');
    var membershipEmailField = navigationDrawer.querySelector('#n-4375-membership-email');
    ...
    var membershipHeaderText = navigationDrawer.querySelector('#n-4375-membership-header');
