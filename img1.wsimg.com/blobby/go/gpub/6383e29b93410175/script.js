(function () {
    ...
    var onClickApplication = setInterval(function () {
      var membershipSignOut = document.getElementById('membership3724181-membership-sign-out');
  ...
  var utilitiesMenu = document.getElementById('membership3724181-utility-menu');
  ...
  if (cookieValue) {
    ...
    var membershipEmailField = utilitiesMenu.querySelector('#membership3724181-membership-email');
    ...
    var membershipHeaderText = utilitiesMenu.querySelector('#membership3724181-membership-header');
