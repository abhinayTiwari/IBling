(function () {
    ...
    var onClickApplication = setInterval(function () {
      var membershipSignOut = document.getElementById('membership6134595-membership-sign-out');
  ...
  var utilitiesMenu = document.getElementById('membership6134595-utility-menu');
  ...
  if (cookieValue) {
    ...
    var membershipEmailField = utilitiesMenu.querySelector('#membership6134595-membership-email');
    ...
    var membershipHeaderText = utilitiesMenu.querySelector('#membership6134595-membership-header');
