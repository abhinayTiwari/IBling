(function () {
    ...
    var onClickApplication = setInterval(function () {
      var membershipSignOut = document.getElementById('n-4462-membership-sign-out');
  ...
  var navigationDrawer = document.getElementById('n-4462-navId-mobile');
  ...
  if (cookieValue) {
    ...
    var membershipHeader = navigationDrawer.querySelector('#n-4462-membership-header');
    var membershipEmailField = navigationDrawer.querySelector('#n-4462-membership-email');
    ...
    var membershipHeaderText = navigationDrawer.querySelector('#n-4462-membership-header');
