(function () {
    ...
    var onClickApplication = setInterval(function () {
      var membershipSignOut = document.getElementById('n-43754408-membership-sign-out');
  ...
  var utilitiesMenu = document.getElementById('n-43754408-utility-menu');
  ...
  if (cookieValue) {
    ...
    var membershipEmailField = utilitiesMenu.querySelector('#n-43754408-membership-email');
    ...
    var membershipHeaderText = utilitiesMenu.querySelector('#n-43754408-membership-header');
