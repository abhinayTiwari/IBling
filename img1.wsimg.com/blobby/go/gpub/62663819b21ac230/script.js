(function () {
    ...
    var onClickApplication = setInterval(function () {
      var membershipSignOut = document.getElementById('n-46454678-membership-sign-out');
  ...
  var utilitiesMenu = document.getElementById('n-46454678-utility-menu');
  ...
  if (cookieValue) {
    ...
    var membershipEmailField = utilitiesMenu.querySelector('#n-46454678-membership-email');
    ...
    var membershipHeaderText = utilitiesMenu.querySelector('#n-46454678-membership-header');
